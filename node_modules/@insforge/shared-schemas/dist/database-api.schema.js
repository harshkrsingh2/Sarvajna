import { z } from 'zod';
import { columnSchema, foreignKeySchema, tableSchema, databaseSchemaInfoSchema, databaseFunctionSchema, databaseIndexSchema, databasePolicySchema, databaseTriggerSchema, migrationSchema, } from './database.schema.js';
...
export const adminTableRecordsListQuerySchema = z
    ...
    .refine((value) => (value.filterColumn === undefined && value.filterValue === undefined) ||
...
export const adminTableRecordUpdateRequestSchema = adminTableRecordSchema.refine((record) => Object.keys(record).length > 0, {
